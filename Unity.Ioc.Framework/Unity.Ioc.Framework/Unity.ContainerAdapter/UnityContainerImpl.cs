...
using Unity.Ioc.Framework.Configuration;
using DependencyAttribute = Unity.Ioc.Framework.Attributes.DependencyAttribute;
using InjectionConstructorAttribute = Unity.Ioc.Framework.Attributes.InjectionConstructorAttribute;
using InjectionMethodAttribute = Unity.Ioc.Framework.Attributes.InjectionMethodAttribute;

namespace Unity.Ioc.Framework.Unity.ContainerAdapter
{
    /// <summary>
